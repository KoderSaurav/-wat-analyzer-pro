...
def load_models():
    ...
    # Temporarily force lightweight mode to avoid 4GB+ download blocking the server start
    logger.info("Skipping model download for fast UI testing, falling back to lightweight mode.")
    return
